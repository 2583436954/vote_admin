...
public interface CommonConstant {
     ...
     * 登录用户Shiro权限缓存KEY前缀
     */
    public static String PREFIX_USER_SHIRO_CACHE = "shiro:cache:com.dunxi.modules.shiro.authc.ShiroRealm.authorizationCache:";
    /**
     * 登录用户Token令牌缓存KEY前缀
     */
     ...
     * 字典类型(0:系统字典,1:个性化字典)
     */
    public static final String SYS_DICT_TYPE_SYSTEM = "0";
    public static final String SYS_DICT_TYPE_INDIVIDUAL = "1";


    /**
     * 客户端的小程序.
     */
    public static final String SYSUSER_APPLETS = "KH";

    /**
     * 客户端小程序跳转陌拜登陆标识.
     */
    public static final Integer CUSTOM_APPLETS_ERRO = 2;

    /**
     * 数字字典是否开启个性化设置(客户自己修改):1--开启,0--关闭(默认)
     */
    public static final String SYS_DICT_TYPE_OPEN = "1";

    /**
     * 布料信息返回标识:0--错误返回,1--正确返回
     */
    public static final String FABRIC_RETURN_ERROR = "0";
    public static final String FABRIC_RETURN_OK = "1";


    /**
     * 布料客户常量
     */
    public static final String FABRIC_CUSTOMER_YH = "yh";
    public static final String FABRIC_CUSTOMER_SZ = "sz";
    public static final String FABRIC_CUSTOMER_DEV = "dev";
